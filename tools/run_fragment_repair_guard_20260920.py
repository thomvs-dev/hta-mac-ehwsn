...
from core.fragment_repair_guard import make_tape,evaluate,POLICIES
...
def main():
    c=json.loads((ROOT/'config/fragment_repair_guard_20260920.json').read_text())
    seeds=list(range(c['seed_start'],c['seed_start']+c['seed_count']))
    assert not set(seeds)&(set(range(3900,3920))|set(range(9700000,9700064))|set(range(9700100,9700164)))
    ...
    for folder in ('fragment_repair_fixed_20260920','fragment_repair_20260920','presence_screen_20260920','recovery_screen_20260920','chronological_screen_20260920'):
    ...
    out=ROOT/'outputs/fragment_repair_guard_20260920';out.mkdir(exist_ok=False)
    ...
    names=['core/fragment_repair_guard.py','core/chronological_calendar.py','core/timed_sleep_mac.py',
        'validation/test_fragment_repair_guard.py','config/fragment_repair_guard_20260920.json',
        'reports/FRAGMENT_REPAIR_GUARD_PROTOCOL_20260920.md','tools/run_fragment_repair_guard_20260920.py',
        'tools/analyze_fragment_repair_guard_20260920.py']
